...
export const metadata: Metadata = {
  title: 'Inventory - Zamto Africa',
  description: 'Browse our complete collection of Japanese imported vehicles available for sale and hire.',
}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 mt-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-700 text-lg">
            Browse our complete collection of Japanese imported vehicles
          </p>
        </div>
