...
export const metadata: Metadata = {
  title: 'Vehicles for Sale - Zamto Africa',
  description: 'Browse our collection of Japanese imported vehicles available for sale.',
}

export default async function VehiclesForSalePage() {
  const vehicles = await getVehiclesByType('sale')
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 mt-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-700 text-lg">
            Browse our collection of Japanese imported vehicles available for purchase
          </p>
        </div>
        ...
        {vehicles.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 text-xl">No vehicles for sale at the moment.</p>
          </div>
        ) : (
