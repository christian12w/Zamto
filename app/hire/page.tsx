...
export default function VehiclesForHire() {
  ...
  const loadVehicles = async () => {
    try {
      ...
      const hireVehicles = vehicleData.filter(vehicle => vehicle.type === 'hire');
      console.log('Filtered hire vehicles:', hireVehicles);
      console.log('Total hire vehicles after filtering:', hireVehicles.length);
