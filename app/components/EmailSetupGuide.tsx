      ...
      <div className="space-y-4 mb-6">
        {steps.map((step) => (
          <div key={step.id} className="flex items-start">
            <div className="flex-shrink-0 h-8 w-8 rounded-full bg-zamtoNavy flex items-center justify-center text-white font-bold mr-3">
              {step.id}
            </div>
            <div className="flex-1">
              ...
              <a 
                ...
                className="inline-flex items-center text-sm text-zamtoOrange hover:text-[#e55a00]"
              >
                {step.action}
