...
const testData = { vehicles: vehicleData };
...
fetch('http://localhost:3001/api/vehicles/import', {
  ...
  headers: {
    ...
    'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY5MWIxNTQ2MTZhNjFjMzUyNDMwMWM1NiIsInVzZXJuYW1lIjoibWFuYWdlciIsInJvbGUiOiJhZG1pbiIsImlhdCI6MTc2MzM4MjU5OSwiZXhwIjoxNzYzNDY4OTk5fQ.bSJwAVtw-UcdOCNdQpdPtGAyEmQUprk7kCGdMYmd3vM'
  },
