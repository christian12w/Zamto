          ...
          <div className="md:col-span-1">
            ...
            <div className="space-y-2">
              <div className="flex items-start space-x-2">
                <MapPinIcon className="h-4 w-4 text-[#FF6600] mt-1 flex-shrink-0" />
                <div>
                  <p className="text-gray-300 text-xs font-medium">Our Location</p>
              ...
              <div className="flex items-center space-x-2">
                <PhoneIcon className="h-4 w-4 text-[#FF6600] flex-shrink-0" />
                <div>
                  <p className="text-gray-300 text-xs font-medium">Call Us</p>
                  <p className="text-gray-300 text-xs">+260 572 213 038</p>
                </div>
              </div>
              <div className="flex items-center space-x-2">
                <MailIcon className="h-4 w-4 text-[#FF6600] flex-shrink-0" />
                <div>
                  <p className="text-gray-300 text-xs font-medium">Email Us</p>
                  <p className="text-gray-300 text-xs">zamtoafrica@gmail.com</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <div className="grid grid-cols-2 gap-1 max-w-xs mx-auto">
              <div className="space-y-1">
                <Link to="/vehicles-for-sale" className="block text-gray-300 hover:text-[#FF6600] transition-colors text-xs text-center">
                  Vehicles For Sale
                </Link>
                <Link to="/vehicles-for-hire" className="block text-gray-300 hover:text-[#FF6600] transition-colors text-xs text-center">
                  Vehicles For Hire
                </Link>
                <Link to="/inventory" className="block text-gray-300 hover:text-[#FF6600] transition-colors text-xs text-center">
                  All Inventory
                </Link>
              </div>
              <div className="space-y-1">
                <Link to="/about" className="block text-gray-300 hover:text-[#FF6600] transition-colors text-xs text-center">
                  About Us
                </Link>
                <Link to="/services" className="block text-gray-300 hover:text-[#FF6600] transition-colors text-xs text-center">
                  Services
                </Link>
                <Link to="/contact" className="block text-gray-300 hover:text-[#FF6600] transition-colors text-xs text-center">
                  Contact
                </Link>
              </div>
            </div>
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/profile.php?id=61581947339658&mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center hover:text-[#FF6600] transition-colors">
                ...
                <span className="text-xs mt-1 text-center">Car Sales</span>
              </a>
              <a href="https://www.facebook.com/share/16yfxxVNUf/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center hover:text-[#FF6600] transition-colors">
                ...
                <span className="text-xs mt-1 text-center">Car Rentals</span>
              </a>
