  ...
  return <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border-2 border-transparent hover:border-[#FF6600] h-full flex flex-col">
      ...
      <div className="p-4 sm:p-6 flex-grow flex flex-col">
        ...
        <div className="border-t border-gray-100 pt-4 mt-auto">
          ...
          {/* Improved button layout for better fit on web version */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
            <button 
              onClick={() => onShowDetails(vehicle)}
              className="flex items-center justify-center bg-gradient-to-r from-[#003366] to-[#004080] hover:from-[#004080] hover:to-[#003366] text-white px-3 py-2 sm:px-4 sm:py-3 rounded-lg font-semibold transition-all transform hover:scale-105 shadow-md"
            >
            ...
            <a 
              ...
              className="flex items-center justify-center bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-3 py-2 sm:px-4 sm:py-3 rounded-lg font-semibold transition-all transform hover:scale-105 shadow-md"
            >
            ...
            <a 
              href="/contact" 
              className="flex items-center justify-center bg-gradient-to-r from-[#FF6600] to-[#e55a00] hover:from-[#e55a00] hover:to-[#FF6600] text-white px-3 py-2 sm:px-4 sm:py-3 rounded-lg font-semibold transition-all transform hover:scale-105 shadow-md"
            >
